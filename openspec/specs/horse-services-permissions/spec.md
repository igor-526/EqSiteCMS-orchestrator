...
## Purpose
Зафиксировать требования к разграничению прав доступа для horse services: пользователи с группой dev/su получают полный CRUD доступ, пользователи с группой admin — могут обновлять услуги (кроме наименования) и читать их, но не могут создавать или удалять. Включить backend permission checks и frontend scope restrictions.
## Requirements
