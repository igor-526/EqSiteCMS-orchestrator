# vk-api-endpoints Specification

## Purpose
REST-контракт приватного `vk-service` для VK-домена: маршруты `/vks*`, access matrix, отображение доменных ошибок в HTTP-статусы и тестовое покрытие.
