...
Зафиксировать SSR-композицию публичной страницы «Наши лошади» (`/loshadi`) и её detail route по slug лошади, включая ограничение видимости detail до `this_stable=true` (site-side privacy guard поверх backend, который сам этот фильтр не применяет), SEO/canonical, responsive-сетку и 404-поведение.
