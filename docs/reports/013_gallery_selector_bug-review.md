...
Frontend bugfix соответствует плану `docs/plans/bugfix/013_gallery_selector_bug.md` и задаче `docs/tasks/013_gallery_selector_bug.md`.
...
- план `docs/plans/bugfix/013_gallery_selector_bug.md` не содержит секции `SMOKE` / `### SMOKE-тесты на реальном API`;
