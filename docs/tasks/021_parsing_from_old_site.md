...
Файл для результата: `docs/plans/parsing_from_old_site/021_step1.md`
# Этап 2
В результате выполнения этапа 1 у нас появился файл `docs/plans/parsing_from_old_site/021_step1.md` с разделом "Pages to parse"
...
Оставь файл инструкции в `docs/plans/parsing_from_old_site/021_step2.md`
# Этап 3
...
# Планирование
Сначала проанализируй полностью json файл. Потом построй план для построения `.sql` файлов. Напиши план по реализации этой задачи в `docs/plans/parsing_from_old_site/021_step3.md`
