# Контекст
В плане `docs/plans/feature/010_horses_management.md` мы реализовывали управление лошадьми
...
В docs/plans/bugfix/013_gallery_selector_bug.md напиши план по исправлению этого бага и отчёт по реализации на frontend