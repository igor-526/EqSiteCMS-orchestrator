...
`docs/plans/feature/004_price_group_ordering.md`):
...
Вызов скилла: `/smoke admin docs/plans/feature/004_price_group_ordering.md`
...
1. **Smoke через скилл** — прогнать 10 ключевых сценариев через `/smoke admin docs/plans/feature/004_price_group_ordering.md`
...
- [x] Запустить smoke через скилл: `/smoke admin docs/plans/feature/004_price_group_ordering.md`
